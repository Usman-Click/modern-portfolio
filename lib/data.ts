...
export const projects: Project[] = [
  {
    ...
    features: [
      "Instant Data & Airtime Top-up",
      "Physical Recharge Card (PRC) Sales",
      "Airtime to Cash Conversion",
      "Secure Wallet Funding",
      "Automated Bill & Utility Payments",
      "Real-time Transaction Insights"
    ],
    colors: ["#0E76FD", "#10B981", "#0F172A"],
    fonts: ["Plus Jakarta Sans", "Inter"]
  },
  {
    id: "visit_arewa",
    name: "Visit Arewa",
    desc: "A digital showcase of Northern Nigeria.",
    icon: "/images/arewa.png",
    image: "/images/arewa-hero.png",
    year: "2026",
    ...
    features: [
      "Interactive Destination Guides (Yankari, Mambilla, etc.)",
      "Arewa Excellence Talent Profiles",
      "Linguistic Heritage Archive (Hausa, Fulfulde, Kanuri, etc.)",
      "Northern Nigeria Culinary & Recipe Guide",
      "Cultural Events & Festivals Calendar (Durbar, Argungu)",
      "Open Source Contribution Model via GitHub"
    ],
    colors: ["#048d2bff", "#105a00", "#8f4e00ff"],
    fonts: ["Playfair Display", "Plus Jakarta Sans"]
  },
  {
    id: "scholaraid",
    name: "Scholaraid",
    desc: "A cloud-native, AI-assisted scholarship management platform designed to bridge the gap between students and providers.",
    icon: "/images/cap.jpg",
    ...
    features: [
      ...
      "Centralized Scholarship Tracking",
      "Automated Provider Dashboards",
      "Real-time Push Notifications"
    ],
    colors: ["#2b4effff", "#5750d3ff", "#44317aff"],
  ...
  },
  {
    ...
    colors: ["#000011", "#0d9700ff", "#b4b4b4ff"],
    fonts: ["Plus Jakarta Sans", "Inter"]
  },
  {
    id: "novetiv",
    name: "Novetiv",
    desc: "AI, robotics, and software solutions company.",
    icon: "/images/novetiv.png",
    image: "/images/novetiv-hero.png",
    year: "2024",
